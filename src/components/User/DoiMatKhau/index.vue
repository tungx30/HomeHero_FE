    ...
    <div class="container mt-5">
        <div class="card shadow-lg p-4 mx-auto" style="max-width: 420px; border-radius: 12px;">
            ...
            <!-- <div data-mdb-input-init class="form-outline mb-4">
                <label class="form-label" for="hash-reset">Mã khôi phục (ID)</label>
                <div class="position-relative">
                    <input type="text" v-model="update_mk.hash_reset" id="hash-reset" class="form-control form-control-lg"
                        placeholder="Nhập mã khôi phục" required />
                </div>
            </div> -->
            <div data-mdb-input-init class="form-outline mb-4">
...
export default {
    ...
    methods: {
        doi_mk() {
            axios
                .post("http://127.0.0.1:8000/api/nguoi-dung/quen-mat-khau/ko-mail", this.update_mk, {
                    headers: {
