<template>
    <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="card mb-4 shadow-sm" style="width: 100%; max-width: 600px;">
            <div class="card-body">
                <h5 class="card-title text-center mb-4">Đơn dịch vụ Định Kì</h5>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Ngày Làm Việc Trong Tuần</th>
                                <td>
                                    <span v-for="(day, index) in workingDays" :key="index">
                                        {{ day }}<span v-if="index < workingDays.length - 1">, </span>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="text-center mt-4">
                    ...
                    <button v-on:click="huyDonHang()" type="button" class="btn btn-danger px-4">Hủy Đơn dịch vụ</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    computed: {
        workingDays() {
            let daysArray = JSON.parse(this.chiTietDonHang.so_ngay_phuc_vu_hang_tuan || "[]");
            const daysMapping = {
                0: "Chủ Nhật",
                1: "Thứ 2",
                2: "Thứ 3",
