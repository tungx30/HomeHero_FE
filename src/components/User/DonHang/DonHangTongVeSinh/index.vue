        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body text-center">
                    <h4 class="text-center mb-4">Tổng Vệ Sinh </h4>
                    ...
                    <div class="section mb-3">
                        <p class="section-title">
                            <i class="fas fa-building text-success"></i> Loại Nhà
                        </p>
                        <div class="property-type-options">
                            <button @click="donHang.loai_nha = 'căn hộ' " class="property-type-item"
                                :class="{ 'active': donHang.loai_nha === 'căn hộ' }">
                                <i class="fas fa-building"></i>
                                <p>Căn hộ</p>
                            </button>
                            <button @click="donHang.loai_nha = 'nhà mặt đất'" class="property-type-item"
                                :class="{ 'active': donHang.loai_nha === 'nhà mặt đất' }">
                                <i class="fas fa-home"></i>
                                <p>Nhà mặt đất</p>
                            </button>
                            <button @click="donHang.loai_nha = 'văn phòng'" class="property-type-item"
                                :class="{ 'active': donHang.loai_nha === 'văn phòng' }">
                                <i class="fas fa-city"></i>
                                <p>Văn phòng</p>
                            </button>
                            <button @click="donHang.loai_nha = 'biệt thự'" class="property-type-item"
                                :class="{ 'active': donHang.loai_nha === 'biệt thự' }">
                                <i class="fas fa-villa"></i>
                                <p>Biệt thự</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="section mb-3">
                        <p class="section-title">
                            <i class="fas fa-clock text-success"></i> Diện Tích
                        </p>
                        <div class="employee-selection">
                            <button @click="donHang.dien_tich_tong_san = 1 , donHang.so_luong_nv = 2"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 1 && donHang.so_luong_nv === 2}">
                                <p>Dưới 60m2 Tổng Sàn</p>
                            </button>
                            <button @click="donHang.dien_tich_tong_san = 1.5 , donHang.so_luong_nv = 3"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 1.5 && donHang.so_luong_nv === 3}">
                                <p>60-90m2 Tổng Sàn</p>
                            </button>
                            <button @click="donHang.dien_tich_tong_san = 2 , donHang.so_luong_nv = 4"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 2 && donHang.so_luong_nv === 4}">
                                <p>trên 90m2-120m2 Tổng Sàn</p>
                            </button>
                            <button @click="donHang.dien_tich_tong_san = 2.5 , donHang.so_luong_nv = 5"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 2.5  && donHang.so_luong_nv === 5}">
                                <p>120-150m2 Tổng Sàn</p>
                            </button>
                            <button @click="donHang.dien_tich_tong_san = 3 , donHang.so_luong_nv = 6"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 3 && donHang.so_luong_nv === 6}">
                                <p>150-180m2 Tổng Sàn</p>
                            </button>
                            <button @click="donHang.dien_tich_tong_san = 3.5 , donHang.so_luong_nv = 7"
                                :class="{ 'employee-btn': true, 'active': donHang.dien_tich_tong_san === 3.5 && donHang.so_luong_nv === 7}">
                                <p>180-210m2 Tổng Sàn</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="section mb3">
                        ...
                        <div class="bottom-bar d-flex justify-content-between align-items-center p-3 mt-4 shadow-sm rounded">
...
export default {
    ...
    watch: {
        'donHang.dien_tich_tong_san': function () {
            this.tinhTongTien();
        },
    ...
    methods: {
        ...
        tinhTongTien() {
            // Tính toán tổng tiền
            this.tong_tien = this.soTienMacDinh * this.donHang.dien_tich_tong_san * this.donHang.so_luong_nv;
...
.bottom-bar {
    ...
    padding: 15px 20px;
    gap: 20px;
    margin-top: 20px; /* Điều chỉnh khoảng cách giữa các phần */
}
...
.left-section {
    ...
    gap: 20px;
    align-items: center;
    flex: 1.5;  /* Chiếm 1/2 không gian bên trái */
    justify-content: space-between;
}
...
.right-section {
    ...
    gap: 20px;
    align-items: center;
    flex: 1;  /* Chiếm 1/2 không gian bên phải */
    justify-content: space-between;
}

/* Căn giữa các thông tin trong mỗi phần */
.info, .pricing, .discount, .total {
    text-align: center;
    flex: 1; /* Đảm bảo mỗi phần chiếm cùng một không gian */
}
