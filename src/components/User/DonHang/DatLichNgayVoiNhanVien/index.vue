        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="section mb-3">
                        <p class="section-title">
                            <i class="fas fa-users text-success"></i> Thông Tin Nhân Viên
                        </p>
                        <div class="nhanvien-thongtin text-center">
                            <img v-bind:src="nhanvien.hinh_anh" alt="" class="rounded-circle p-1 bg-primary" width="110"
                                height="110">
                            <h4 class="mt-2 name">{{ nhanvien.ho_va_ten }}</h4>
                        </div>
                    </div>
                    <div class="section mb-3">
                        <p class="section-title">
...
export default {
    ...
    methods: {
        ...
        tinhTongTien() {
            // Tính toán tổng tiền
            this.tong_tien = this.soTienMacDinh * this.donHang.so_gio_phuc_vu;
        ...
        createDonHang() {
            const idNhanVien = this.$route.params.id_nhan_vien; // Lấy id từ URL params
            axios.post(`http://127.0.0.1:8000/api/nguoi-dung/dat-don-hang-voi-nhan-vien/create/${idNhanVien}`, this.donHang, {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem("token_nguoi_dung")
                }
            })
...
.total {
    text-align: center;
    flex: 1;
    /* Đảm bảo mỗi phần chiếm cùng một không gian */
}
